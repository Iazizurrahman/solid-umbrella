...
import {
  ...
  ResourcesDropdown,
  ServicesDropdown,
} from "@/components/sites/www-nscale-com-782295e3/root-8a5edab2/HeaderDropdowns";
import { MobileMenu } from "@/components/sites/www-nscale-com-782295e3/root-8a5edab2/MobileMenu";
...
type DropdownKey = "centers" | "services" | "company" | "resources";

const DROPDOWN_PANELS: Record<
  DropdownKey,
  (props: { open: boolean }) => React.JSX.Element
> = {
  centers: CentersDropdown,
  services: ServicesDropdown,
  company: CompanyDropdown,
  resources: ResourcesDropdown,
};

const NAV_TRIGGERS: { key: DropdownKey; label: string; simple: boolean }[] = [
  { key: "centers", label: "Data Centers", simple: false },
  { key: "services", label: "Services", simple: false },
  { key: "company", label: "Company", simple: true },
  { key: "resources", label: "Resources", simple: true },
];
        ...
        <Container>
          ...
          <div className="relative flex items-center justify-between py-[1.0625rem] max-[991px]:py-2">
            ...
            <div className="flex items-center justify-start gap-14">
              ...
              <a href="/" aria-current="page" aria-label="Nscale home">
                ...
                {/* .header_logo.is-mobile — the 32x16 mark, only <=767 */}
              ...
              <nav className="flex items-stretch justify-start gap-3 max-[991px]:hidden">
                {NAV_TRIGGERS.map(({ key, label, simple }) => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        "flex rounded-[6px] border border-transparent transition-all duration-200 hover:border-ns-border-glass-primary hover:bg-ns-bg-glass-primary",
                        // Only the narrow `.is-simple` panels resolve against
                        // their own item; the wide ones need `.header_wrap`.
                        simple && "relative",
                      )}
                    >
                      {/* .header_nav_link */}
                ...
                {/* Contact — a plain link, no dropdown */}
                <div
                  data-menu-link="trigger"
                ...
                >
                  ...
                  >
                    <div className="text-sm leading-4">Contact</div>
                  </a>
                </div>
              </nav>
            </div>
            ...
            <div className="max-[991px]:flex max-[991px]:items-center max-[991px]:justify-start max-[991px]:gap-4">
              <a
                href="https://console.nscale.com/"
                target="_blank"
                rel="noreferrer"
              >
                <HeaderButton label="Login" variant="glass" />
              </a>

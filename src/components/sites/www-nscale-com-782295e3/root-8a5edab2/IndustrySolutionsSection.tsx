...
import type { IndustrySolution } from "@/types/nscale";

const IMAGE_BASE = "/sites/www-nscale-com-782295e3/root-8a5edab2/images";

/**
 * The two `.use-case_item` entries rendered by the Webflow CMS list, in source order.
 * Artwork filenames keep the Webflow asset hash of the original `<img src>`
 * (`…_use-case_image-wrap.jpg` and `…_image%2019.jpg` → `…_image-19.jpg`).
 */
const INDUSTRY_SOLUTIONS: readonly IndustrySolution[] = [
  {
    id: "telco",
    tabLabel: "Telecommunication",
    title: "Telecommunication",
    subtitle: "Scalable, AI-native infrastructure",
    description:
    ...
    image: `${IMAGE_BASE}/69fcef17697690e9da6c548d_use-case_image-wrap.jpg`,
    imageAlt: "",
    href: "/telco",
  },
  {
    ...
    tabLabel: "AI Native",
    title: "AI Native",
    subtitle: "Accelerated AI model deployment",
    description:
    ...
    image: `${IMAGE_BASE}/69fcf00177424da8a4dc51f7_image-19.jpg`,
    imageAlt: "",
    href: "/ai-native",
  },
];
...
/**
 * `.section` + `.section_use-case` — "Industry solutions that scale with you" on the blue
 * gradient band.
 *
 ...
 * Telecommunication card with JS disabled.
 *
